                ...
                <div style="height: 100vh;" class="py-4 col-md-3 bg-danger-subtle">
                    <div class="container">
                        ...
                        <div class="col mt-3">
                            ...
                            <asp:TextBox runat="server" ID="txt_id" Visible="false" />

                        </div>

                        <div class="row mt-3  d-flex justify-content-center">
                            <div class="col-4">
                                <asp:Button Text="Save" CssClass="px-4 btn btn-success" runat="server" ID="submit_btn" OnClick="btn_submit_Click" />
                            </div>
                            <div class="col-4">
                ...
                <div class="col-md-9 bg-info-subtle">
                    <div class="container py-4">
                        ...
                        <div class="row">
                            ...
                            <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="false" CssClass="table table-bordered border-dark-subtle px-4" DataKeyNames="ID" OnRowCommand="GridView_RowCommand">
                                <Columns>
                                    <asp:TemplateField Visible="false" HeaderText="ID">
                                        <ItemTemplate>
                                            <asp:Label Text='<%#Eval("ID") %>' runat="server" ID="lbl_Id" Visible="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Update/Remove">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="DeleteButton" Text="Delete" CssClass="btn btn-danger" CommandName="DeleteRecord" CommandArgument='<%# Eval("ID") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
